...
### Key Idea:
We count how many ways we can pick characters from "babgbag" to form "bag" while maintaining order.
There are multiple choices for 'b', 'a', and 'g', leading to different valid subsequences.

### Final DP Result:
The value at `dp[7][3]` gives the answer.
...
![Code Accepted](<img width="1919" height="971" alt="Screenshot 2026-04-23 180740" src="https://github.com/user-attachments/assets/8d97da06-0853-4ba0-af92-485251f7a961" />)
